...
public class Serv_DeleteFolder extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            f=request.getParameter("fol");
            int r=st.executeUpdate("delete from folders where uname='"+uname+"'and fname='"+f+"'");
            if (r!=0)
            {
                sos.println("<html><body bgcolor=cyan text=blue><h2><i>  Folder "+f+" Deleted successfully.</i></h2></body></html>");
