...
public class Serv_DeleteCkd extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            int cnt=Integer.parseInt(request.getParameter("hid"));
            for (int i=1;i<=cnt;i++)
            {
                String chk=request.getParameter("b"+i);
                if(chk!=null)
                {
                    ...
                    if(y > 0)
                    {
                        ...
                        response.setHeader("Refresh","2;URL=http://localhost:8081/Email2/Serv_Inbox"); 
